...
<section class="feel-student">
    <div class="container">
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            <!-- Các nút chuyển slide (các nút xám) -->
                ...
                <div class="carousel-item active">
                    <div class="testimonial">
                        <div class="testimonial-img">
                            <img src="https://nld.mediacdn.vn/2019/12/26/hanh-trinh-di-san-1-1577106877680x0-1577339097206661047551.jpg"
                                class="d-block" alt="Slide 1 Image" />
                        </div>
                        <div class="testimonial-content">
                            <h3>Nguyễn Văn Hùng - Công nghệ thông tin</h3>
                            <p>
                                "Chương trình học ở Fast Learn rất chuyên
                                sâu và đáp ứng nhu cầu về thị trường nhân
                                lực."
                            </p>
                        </div>
                    </div>
